...
SECRET_KEY = 'django-insecure-+%o+d+ipjq09zk$jcp0*%e8)w1evq6@v56jede7^-)%2zo#sc7'
...
ROOT_URLCONF = 'django_accounts.config.urls'
...
WSGI_APPLICATION = 'django_accounts.config.wsgi.application'
